...
| | Les musiciens, à chaque secondes |
|Question | Who is going to **listen for UDP datagrams** and what should happen when a datagram is received? |
| | L'auditeur, il va ajouter le musicien a la liste si il n'y est pas déja |
|Question | What **payload** should we put in the UDP datagrams? |
| | Le nom et le son de l'instrument,ainsi que son identifiant |
...
| | un gestionaire de paquets pour javascript  |
|Question | What is the `npm install` command and what is the purpose of the `--save` flag?  |
| | npm install installe un package et --save l'ajoute à la dépendance  |
|Question | How can we use the `https://www.npmjs.com/` web site?  |
| | Pour la documentation et les packages  |
...
| | avec la commande :  docker build nom_image|
|Question | How can we use the `ENTRYPOINT` statement in our Dockerfile?  |
| | Avec la commande node pour lancer l'app  |
|Question | After building our Docker image, how do we use it to **run containers**?  |
| | avec docker run nom_image  |
...
| | En créant une nouvelle map, et en liant le paramètre à la map avec la methode get |
...
| | en créant plusieurs musiciens et un auditeur, et en utilisant tcpdump pour controller que les paquets sont bien envoyés |
